					...
					$.ajax({
	    		        ...
	    		        success:function(data) {
	    		        	...
	    		        	if(data['status'] == false) {
	    		        		...
	    		        		//$('input[name="criteria"][value="' + data['data'][0]['BasicCriteria'] + '"]').attr('checked', 'checked');
...
//    $('#loadSubChannel').bind('click', function() {
//    	
//    	 $.ajax({
//    	        url: pathFixed+'dataloads/channels',
//    	        type: "GET",
...
//    });
//    
//    $('#loadChannel').bind('click', function() {
//
//    	var selects = subgroup.val();
//        if(selects != "") {
//
...
//    		$('#refertl_element').removeClass('hide');
//			$('#referbm_element').addClass('hide');
//			
//			$('#refer_bm_criteria').prop('checked', false);
//			$('#refer_bm').find('option[value=""]').prop('selected', false);
    ...
    /*
    $('#refer_bm_criteria').click(function() {
    	var field_checked = $(this).is(':checked');
    	if(field_checked) {
    		loadBranchManagerInfo('#refer_bm', objbranch);
    		$('#refer_bm').removeAttr('disabled');
    	} else {
    		$('#refer_bm').attr('disabled', 'disabled').val('');
    	}
    ...
    */
    ...
    function setFieldReferralAutoCompleted(element, enabled) {
    	...
    	if(enabled) {
    		...
    		/*
    		var refer_channel = ['Field visit','Refer: RM','Refer: Customer','Call in','Walk in','Direct mail','Telelist','Refer: BM','Refer: Full Branch','Refer: Call Center','Tcrb: Facebook'];
        	var select_source = $('#sourceofcustomer').val();
        	if(in_array(select_source, refer_channel)) {
    			$('#refertl_element').addClass('hide');
    			$('#referbm_element').removeClass('hide');
    			
    			var source  = switchSourceType(select_source)
    			loadBranchManagerInfo('#refer_bm', objbranch, source);
