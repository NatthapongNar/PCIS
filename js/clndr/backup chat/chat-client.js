angular.module("chat-client", [
    ...
    .directive('modalDragable', function () {
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                $(elem).closest(".modal-dialog").draggable();
            }
        };
    })
                    ...
                    if (scope.groupProfilePicture) {
                        ...
                        helper.file_upload(groupFilePictureName, groupPicture).then(function (resp) {
                            var param = {
                                ...
                                Group_Image: "http://172.17.9.94/newservices/LBServices.svc/chat/group/image/" + groupFilePictureName
                            };
    ...
    .controller("testuplod", function ($scope, helper, fileUpload, $http) {
