...
(function (factory) {
    ...
    defaultFileActionSettings = {
        removeIcon: '<i class="fa fa-remove text-danger"></i>',
        ...
        indicatorError: '<i class="fa fa-info-circle text-danger"></i>',
        indicatorLoading: '<i class="fa fa-hand-pointer-o text-muted"></i>',
