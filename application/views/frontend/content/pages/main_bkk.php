...
<!-- <img src="<?php echo base_url('img/black_ribbon_top_left.png'); ?>" class="animated fadeIn" style="position: absolute; margin-top:-47px; left: -66px;" draggable="false"> -->
...
<div style="margin-left: 100px">
	...
	<p style="font-weight: bold; text-align: center; font-size: 0.95em; margin-top: 15px; margin-bottom: -35px; line-height: 2.5; margin-left: -120px; min-width: 1240px;" class="th_charmonman animated zoomIn"><?php echo $royalGuidance['data'][0]['RoyalGuidance']; ?></p>
...
<div class="tile-group no-margin no-padding1 clearfix" style="width: 100%; margin-left: -70px !important; margin-top: 10px !important">
    ...
    <div class="hide" style="position: absolute; min-height: 550px; right: -40px; border: 1px solid #D1D1D1; width: 140px; background: #bcb4b4;"></div>
    	...
    	<div id="tile_ctrl" style="position: absolute; top: 10px; left: 0; width: 140px; display: inline;">
    		<a href="<?php echo site_url('metro'); ?>">
    			<div id="tile_lb" class="btn_circle" data-dapart="LB" style="margin-right: 5px;">LB</div>
    		</a>
    		<a href="<?php echo site_url('metro/bkk'); ?>" >
    			<div id="tile_bkk" class="btn_circle active" data-dapart="BKK" style="margin-right: 5px;">BKK</div>
    		</a>
    	</div>
    	<?php } ?>
			...
			<div class="tile-content text-center fg-white">
	            <div class="col-subspan">
					<div class="col-subspan bg-darkCyan fg-white" style="border-right: 1px solid #FFF; min-height: 120px;">
						<a href="http://tc001pcis1u:8099/pcis/index.php/metro/createprofile" class="fg-white" target="_blank">
						...
						<a href="http://tc001pcis1u:8099/pcis/index.php/metro/appProgress" class="fg-white" target="_blank">
			...
			<div class="tile-content fg-white">
	             <div class="col-subspan"  style="border-left: 1px solid #FFF;">
	          	    ...
	          	    <div class="brand brand-custom text-center padding_none" style="font-size: 0.8em; margin-top: -5px; padding-top: 10px; max-height: 20px !important; background-color: rgba(130, 90, 44, .7) !important; !important;">
	          	    	<a href="http://tc001pcis1u:8099/pcis/index.php/metro/fnReconcileNCB" class="fg-white" target="_blank">
		...
		<div class="tile bg-amber animated fadeInDown">
			<div class="tile-content fg-white">
	            <div class="col-subspan" style="border-right: 1px solid #FFF;">   
		          	<div class="brand brand-custom text-center padding_none" style="font-size: 0.8em; margin-top: -5px; padding-top: 10px; max-height: 20px !important; background-color: rgba(130, 90, 44, .7) !important; !important;">
	          	    	<a href="http://tc001pcis1u:8099/pcis/index.php/reconcile/vwAppManagement?filter=reconcile" class="fg-white" target="_blank">
		...
		<div class="tile live double animated fadeInDown" data-role="live-tile" data-effect="slideUpDown" data-easing="easeInSine" style="position: absolute; margin-top: 130px;">
			<div class="tile-content text-center fg-white">	       
	            <div class="col-subspan">
					<div class="col-subspan fg-white bg-gray" style="border-right: 1px solid #FFF; min-height: 120px; ">
						<a href="http://tc001pcis1u:8099/pcis/index.php/defend_control/defenddashboard" class="fg-white" target="_blank">
						...
						<div class="col-subspan spanhalf text-center" style="min-height: 60px; max-height: 60px; border-bottom: 1px solid #FFF; border-left: 1px solid #FFF;">
							<div class="tile live col-subspan spanhalf bg-gray" style="min-height: 60px; max-height: 60px; border-bottom: 1px solid #FFF;">
								<div class="tile-content col-subspan spanhalf" style="min-height: 60px; max-height: 60px;">
									...
									<div class="col-subspan spanhalf subheader def_newVal marginTop10 text-center fg-white animated fadeIn">0</div>
							    	<div class="col-subspan spanhalf text-center" style="font-size: 0.7em; margin-top: 5px;">NEW</div>
								</div>
								<!-- 
								<div class="tile-content col-subspan spanhalf" style="min-height: 60px; max-height: 60px;">
									<div id="def_activeAch" class="col-subspan spanhalf text-right hide" style="font-size: 0.5em; margin-left: -3px; position: absolute;">Ach. 0%</div>
									<div id="def_activeVal" class="col-subspan spanhalf subheader marginTop10 text-center fg-white animated fadeIn">0</div>
						   	 		<div class="col-subspan spanhalf text-center" style="font-size: 0.7em; margin-top: 5px;">ACTIVE</div>
								</div>
								-->
							</div>					
						</div>
						<div class="col-subspan bg-mauveLight fg-white" style="min-height: 65px; border-left: 1px solid #FFF;">
							<div id="defend_completedActual" class="col-subspan subheader marginTop5 text-center fg-white animated fadeIn">0</div>
						    <div id="defend_completedPercent" class="col-subspan text-center" style="font-size: 0.7em; margin-top: 5px;">TOTAL ACTIVE 0%</div>
						</div>	
					</div>					
	            </div>    
        			 	...
        			 	<div class="col-subspan text-left" style="font-size: 0.8em; margin-left: 5px;">
        			 		<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_label0 text-center" style="margin-top: 3px; margin-left: -5px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important;">(%)</span>
		          			<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_label1 text-center" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1);  font-size: 0.8em !important;">0</span>
					   		...
					   		<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_label4" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
					   		<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_label5" style="margin-top: 3px; margin-left: 1px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		          		</div>		          		
		          	  	<div class="col-subspan text-left" style="font-size: 0.8em; margin-left: 5px;">
					    	...
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_accu_label4" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown cmpt_accu_label5" style="margin-top: 3px; margin-left: 1px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		          	  	</div>		          	  	
		          		...
		          		<div class="col-subspan fg-white" style="margin-top: 15px; margin-left: 0px; position: absolute; bottom: 10px;">
							<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 20px;"><small>SB</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 5px;"><small>SME</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 5px;"><small>DIG</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 5px; display: none;"><small></small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 10px !important; margin-left: 7px; display: none;"><small></small></div>
						</div>				    
	        ...
	        <div class="tile-content text-center fg-white">	       
	            <div class="col-subspan bg-green">
					...
					<div class="col-subspan bg-green fg-white" style="min-height: 65px; border-left: 1px solid #FFF;">
						<div id="defend_usageActual" class="col-subspan subheader marginTop5 text-center fg-white animated fadeIn">0</div>
						<div id="defend_usagedPercent" class="col-subspan text-center" style="font-size: 0.7em; margin-top: 5px;">TOTAL USAGE 0%</div>
					</div>	
	            </div>  
	            ...
	            <div class="col-subspan bg-green"  style="min-height: 125px;">
					<div class="col-subspan">        		 	
        			 	<div class="col-subspan text-left" style="position: absolute; margin-top: 0px; font-size: 0.8em;">
					    	...
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown defendLabelAt_4" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown defendLabelAt_5" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		          	  	</div>          	  	
					    	...
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown defendActualLabel4" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
					    	<span class="col-subspan spanxs label_subtitle animated fadeInDown defendActualLabel5" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		          	  	</div>
		          		...
		          		<div class="col-subspan fg-white" style="margin-top: 15px; margin-left: 0px; position: absolute; bottom: 10px;">
							<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 20px;"><small>SB</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 3px;"><small>SME</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 5px;"><small>DIG</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 5px; display: none;"><small>S</small></div>
			          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 10px !important; margin-left: 7px; display: none;"><small>I</small></div>
						</div>		
		...
		<div class="tile bg-amber animated fadeInDown" style="position: absolute; margin-top: 130px; margin-left: 260px;">
			<div class="tile-content text-center fg-white">
	            <div class="col-subspan fg-white" style="min-height: 125px; border-right: 1px solid #FFF;">
	          	  	<div class="brand brand-custom text-center padding_none" style="font-size: 0.8em; margin-top: -5px; padding-top: 10px; max-height: 20px !important; background-color: rgba(130, 90, 44, .7) !important; !important;">
	          	    	<a href="http://tc001pcis1u:8099/pcis/index.php/reconcile/vwAppManagement?filter=missingdoc" class="fg-white" target="_blank">
		          	    	<div class="text-left paddingLeft5" style="width: 92px; max-width: 88px; min-height: 29px; padding-top: 8px;">
	          	  	...
	          	  	<div class="col-subspan">
	          	  		...
	          	  		<div class="col-subspan text-center" style="height: 45.5px;">
	          	  			<div id="fromrm_val" class="col-subspan hide" style="margin-top: 0px;"><h4 class="fg-white">0</h4></div>
	          	  			<div id="fromrm_ach" class="col-subspan hide" style="font-size: 0.8em; margin-top: 0px;">FROM RM (0%)</div>
	          	  		</div>
	          	  		<div id="fromca_container" class="col-subspan text-center" style="height: 45.5px;">
		...
		<div class="tile bg-amber animated fadeInDown" style="position: absolute; margin-top: 130px; margin-left: 390px;">
			<div class="tile-content text-center fg-white">
	            <div class="col-subspan fg-white" style="min-height: 125px; border-left: 1px solid #FFF;">
						<div class="brand brand-custom text-center padding_none" style="font-size: 0.8em; margin-top: -5px; padding-top: 10px; max-height: 20px !important; background-color: rgba(130, 90, 44, .7) !important; !important;">
		          	    <a href="http://tc001pcis1u:8099/pcis/index.php/reconcile/vwAppManagement?filter=returndoc" class="fg-white" target="_blank">
		          	    	<div class="text-left paddingLeft5" style="width: 92px; max-width: 88px; min-height: 29px; padding-top: 8px;">
    ...
    <a href="http://tc001pcis1u:8099/pcis/index.php/referral_control" target="_blank">
    ...
    <div class="tile" style="position: absolute; margin-left: 520px; margin-top: 130px;">
    	<div class="col-subspan col-subspan-height paddingLeft10 bg-crimson">
        	<div class="col-subspan fg-white">
        		...
        		<span id="tlvol_header4" class="col-subspan spanxs label_subtitle animated fadeInDown" style="margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, .7); display: none;"></span>
        		<span id="tlvol_header5" class="col-subspan spanxs label_subtitle animated fadeInDown" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, .7); display: none;"></span>
        	</div>
        	...
        	<div id="ytdlabel_sb_tlvolume" class="col-subspan fg-white hide" style="margin-top: 0px; margin-left: -15px;">
				<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 18px !important; margin-left: 27px;"><small>SB</small></div>
          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 20px !important; margin-left: 0px;"><small>SME</small></div>
          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 19px !important; margin-left: 0px;"><small>DIG</small></div>
          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 19px !important; margin-left: 2px; display: none;"><small></small></div>
          		<div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 10px !important; margin-left: 1px; display: none;"><small></small></div>
			</div>	
		    ...
		    <div class="col-container fg-white">
		        <div class="col-subspan col-subspan-height bg-brown" style="border-top: 2px solid white; border-right: 2px solid white;">
		            ...
		            <div class="col-subspan text-left" style="font-size: 0.8em; margin-left: 0px;">
		                ...
		                <span class="col-subspan spanxs label_subtitle nanomicro_ach_vol4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		                <span class="col-subspan spanxs label_subtitle nanomicro_ach_vol5" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		            </div>
		            ...
		            <div class="col-subspan text-left" style="font-size: 0.8em; margin-left: -3px;">
		                ...
		                <span class="col-subspan spanxs label_subtitle nanomicro_vol4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		                <span class="col-subspan spanxs label_subtitle nanomicro_vol5" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		            </div>
		            ...
		            <div class="col-subspan fg-white" style="margin-top: -1px; margin-left: 8px; max-width: 110px;">
		                <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 16px;"><small>SB</small></div>
		                <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 2px;"><small>SME</small></div>
		                <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 6px;"><small>DIG</small></div>
		                <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 4px; display: none;"><small></small></div>
		                <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 10px !important; margin-left: 5px; display: none;"><small></small></div>
		            </div>
		        ...
		        <div class="col-subspan col-subspan-height bg-brown" style="border-top: 2px solid white;">
		            ...
		            <div class="col-subspan text-left" style="font-size: 0.8em; margin-left: 0px;">
		                ...
		                <span class="col-subspan spanxs label_subtitle appin_nanomicro_ach_vol4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		                <span class="col-subspan spanxs label_subtitle appin_nanomicro_ach_vol5" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		            </div>
		            ...
		            <div class="col-subspan text-left" style="font-size: 0.8em; margin-left: -3px;">
		                ...
		                <span class="col-subspan spanxs label_subtitle appin_nanomicro_vol4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		                <span class="col-subspan spanxs label_subtitle appin_nanomicro_vol5" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		            </div>
       			...
       			<div class="tile-content col-subspan-minfix col-subspan-height bg-brown">
		            ...
		            <div class="col-subspan-minfix paddingTop15 text-center" style="min-height: 96px; max-height: 96px;">
		                ...
		                <div id="" class="col-subspan-height" style="position: absolute; top: 25px; left: -18px; ">
		                    <ul class="fg-white" style="list-style: none; font-size: 0.7em;">
		                        <li class="" style=""><small style="font-size: 0.9em; display: none;">SB</small></li>
		                        <li class="" style="margin-top: -5px;"><small style="font-size: 0.9em; display: none;">SME</small></li>
		                        <li class="" style="margin-top: -4px;"><small style="font-size: 0.9em; display: none;">DIG</small></li>
		                        <li class="" style="margin-top: -5px;"><small style="font-size: 0.9em; display: none;"></small></li>
		                        <li class="" style="margin-top: -4px;"><small style="font-size: 0.9em; display: none;"></small></li>
		                    </ul>
		                </div>
				    ...
				    <div class="col-subspan" style="display: inline;">	
			        	...
			        	<div id="tlagent_atlabels" class="col-subspan-height" style="position: absolute; margin-top:10px; margin-left: -15px;">
				        	<ul class="fg-white" style="list-style: none; font-size: 0.7em;">
				        		...
				        		<li class="tlagent_atlabel3" style="margin-top: -7px;"><small></small></li>
				        		<li class="tlagent_atlabel4" style="margin-top: -8px;"><small></small></li>
				        		<li class="tlagent_atlabel5" style="margin-top: -7px; padding-left: 3px"><small></small></li>
				        	</ul>
				        </div>	
		...
		<div class="tile live bg-darkCyan animated fadeInDown" data-role="live-tile" data-effect="slideUpDown" style="position: absolute; right: -30px; margin-top: 128px; min-height: 123px !important;">
			...
			<div class="tile-content col-subspan-minfix col-subspan-height bg-darkCyan" style="max-height: 120px !important;">
			    ...
			    <div class="col-subspan text-left" style="font-size: 0.8em; margin-left: 0px; margin-top: 0px; margin-bottom: 5px;">
			        ...
			        <span class="col-subspan spanxs label_subtitle nplos_label4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
			        <span class="col-subspan spanxs label_subtitle nplos_label5" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
			    </div>
			    ...
			    <div class="col-subspan fg-white" style="margin-top: -2px; margin-left: 6px; max-width: 110px;">
			        <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 20px;"><small>SB</small></div>
			        <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 4px;"><small>SME</small></div>
			        <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 4px;"><small>DIG</small></div>
			        <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 15px !important; margin-left: 4px;"><small></small></div>
			        <div class="col-subspan spanxs" style="max-height: 10px; font-size: 0.7em; max-width: 10px !important; margin-left: 5px;"><small></small></div>
			    </div>
			</div>
		...
		<div class="tile live animated fadeInDown" data-role="live-tile" data-effect="slideUpDown" style="position: absolute; right: -165px; margin-top: 128px; min-height: 124px; min-width: 125px;"">				
			...
			<div class="tile-content col-subspan-minfix col-subspan-height margin_none bg-orange">
		        ...
		        <div id="h4c_mtdlabel" class="col-subspan text-left hide" style="font-size: 0.8em; margin-left: 0px;">
		            ...
		            <span class="col-subspan spanxs label_subtitle h4c_mtdchart_ach4" style="margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		            <span class="col-subspan spanxs label_subtitle h4c_mtdchart_ach5" style="margin-top: 3px; margin-left: 1px; color: rgba(255, 255, 255, 1); font-size: 0.8em !important; display: none;">0</span>
		        </div>
...
<?php 
	...
	if(!in_array($session_data['emp_id'], $this->config->item('Administrator')) || !in_array($user_role, array('rd_role', 'am_role', 'hq_role')) || 
...
<div class="tile-group no-margin no-padding1 clearfix" style="width: 100%; margin-left: -70px !important;">
    <span class="tile-group-title span12" style="font-size: 1.5em; margin-top: -0.7em; font-weight: 200; min-width: 1340px;">
    	...
    	<span id="filter_connect" style="position: absolute; margin-left: 10px; font-size: 0.9em; margin-top: 8px; z-index: 9988; display: none;">
    		<i class="fa fa-bar-chart fg-green fg-red hide"></i>
    	</span>
    	<div class="input-control select span4 fg-black" <?php echo $filter_usage; ?>>
	    	<select id="empoption_list" name="empoption_list" style="max-width: 250px;" disabled></select>
	    </div>
	    <div style="max-height: 37px;position: absolute; right: 0; margin-top: -42px;">
		    <span id="filter_connect_collection" style="position: absolute; margin-left: 10px; font-size: 0.9em; margin-top: 8px; z-index: 999; display: none;"><i class="fa fa-user fg-red"></i></span>
	    	<div class="input-control select span4 fg-black" <?php echo $filter_usage; ?>>
  	...
  	<!-- <?php if(in_array($session_data['emp_id'], $this->config->item('Administrator')) || in_array($user_role, array('rd_role', 'am_role', 'hq_role')) || ($user_role == 'admin_role' && $session_data['branchcode'] === '000')) echo 'data-role="live-tile" data-effect="slideUpDown" data-easing="easeInBack"'; ?> --> 
	<div id="Whiteboard" class="tile double double-vertical ol-transparent live" <?php if(in_array($session_data['emp_id'], $this->config->item('Administrator')) || in_array($user_role, array('rd_role', 'am_role', 'hq_role')) || ($user_role == 'admin_role' && $session_data['branchcode'] === '000')) echo 'data-role="live-tile" data-effect="slideUpDown" data-easing="easeInBack"'; ?> style="margin-top: -10px;">
			...
			<div class="grid fg-white marginTopEasing15">
				<div class="row">
					<div class="span6 marginTopEasing5">
						<a href="http://tc001pcis1u:8099/pcis/index.php/report/whiteboard" target="_blank">
			...
			<div class="col-container bg-darkCyan fg-white" style="margin-top: -18px;">
				...
				<div class="col-subspan" style="min-height: 110px; height: 110px; vertical-align: baseline; border-bottom: 1px solid white; border-top: 1px solid white;">
					...
					<div class="col-subspan marginTop5">
						...
						<div class="col-subspan spanxs label_subtitle sb_volspan_1" style="margin-left: 28px; color: rgba(255, 255, 255, .7);"><small>0</small></div>
          				<div class="col-subspan spanxs label_subtitle sb_volspan_2" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"><small>0</small></div>
          				<div class="col-subspan spanxs label_subtitle sb_volspan_3" style="color: rgba(255, 255, 255, .7);"><small>0</small></div>
					</div>
					...
					<div id="legend_sb_bar" class="col-subspan" style="margin-top: -2px; visibility: hidden;">
						<div class="col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 27px; color: rgba(255, 255, 255, .7);"><small>SB</small></div>
          				<div class="col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 0px; color: rgba(255, 255, 255, .7);"><small>SME</small></div>
          				<div class="col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"><small>DIG</small></div>
					</div>	
				...
				<div class="col-subspan" style="min-height: 110px; height: 110px; vertical-align: baseline; border: 1px solid white; border-left: 2px solid white;">
					...
					<div class="col-subspan marginTop5">
						...
						<div class="col-subspan spanxs label_subtitle a2ca_volspan_1 animated fadeInDown" style="margin-left: 23px; color: rgba(255, 255, 255, .7);"><small>0</small></div>
          				<div class="col-subspan spanxs label_subtitle a2ca_volspan_2 animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"><small>0</small></div>
          				<div class="col-subspan spanxs label_subtitle a2ca_volspan_3 animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);">0</div>
					</div>
					...
					<div id="legend_a2ca_bar" class="col-subspan" style="margin-top: -2px; visibility: hidden;">
						<div class="col-subspan spanxs label_subtitle" style="margin-left: 24px; color: rgba(255, 255, 255, .7);"><small>SB</small></div>
          				<div class="col-subspan spanxs label_subtitle" style="margin-left: 0px; color: rgba(255, 255, 255, .7);"><small>SME</small></div>
          				<div class="col-subspan spanxs label_subtitle" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"><small>DIG</small></div>
					</div>
			...
			<div class="col-container bg-darkCyan fg-white" style="margin-top: -18px;">			
				<div class="col-subspan" style="min-height: 110px; height: 110px; vertical-align: baseline; border-bottom: 1px solid white; border-top: 1px solid white;">
					...
					<div class="col-subspan" style="min-height: 110px; height: 110px; vertical-align: baseline; border-bottom: 1px solid white; ">
						...
						<div class="col-subspan marginTop5">
							...
							<div class="col-subspan spanxs label_subtitle sb_volspanauth_1 animated fadeInDown" style="margin-left: 28px; color: rgba(255, 255, 255, .7);">0</div>
	          				<div class="col-subspan spanxs label_subtitle sb_volspanauth_2 animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);">0</div>
	          				<div class="col-subspan spanxs label_subtitle sb_volspanauth_3 animated fadeInDown" style="color: rgba(255, 255, 255, .7);">0</div>
						</div>
						...
						<div id="legend_sb_bar_auth" class="col-subspan" style="margin-top: -2px; visibility: hidden;">
							<div class="col-subspan spanxs label_subtitle sb_vollabel_auth_1" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 27px; color: rgba(255, 255, 255, .7); font-size: 80%;">SB</div>
	          				<div class="col-subspan spanxs label_subtitle sb_vollabel_auth_2" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, .7); font-size: 80%;">SME</div>
	          				<div class="col-subspan spanxs label_subtitle sb_vollabel_auth_3" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, .7); font-size: 80%;">DIG</div>
						</div>	
				...
				<div class="col-subspan" style="min-height: 110px; height: 110px; vertical-align: baseline; border: 1px solid white; border-left: 2px solid white;">
					...
					<div class="col-subspan marginTop5">
						...
						<div class="col-subspan spanxs label_subtitle a2ca_volspanauth_1 animated fadeInDown" style="margin-left: 23px; color: rgba(255, 255, 255, .7);">0</div>
          				<div class="col-subspan spanxs label_subtitle a2ca_volspanauth_2 animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);">0</div>
          				<div class="col-subspan spanxs label_subtitle a2ca_volspanauth_3 animated fadeInDown" style="color: rgba(255, 255, 255, .7);">0</div>
					</div>
					...
					<div id="legend_a2ca_bar_auth" class="col-subspan" style="margin-top: -2px; visibility: hidden;">
						<div class="col-subspan spanxs label_subtitle a2ca_labelauth_1" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 24px; color: rgba(255, 255, 255, .7); font-size: 80%;">SB</div>
          				<div class="col-subspan spanxs label_subtitle a2ca_labelauth_2" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 0px; color: rgba(255, 255, 255, .7); font-size: 80%;">SME</div>
          				<div class="col-subspan spanxs label_subtitle a2ca_labelauth_3" style="letter-spacing: 1px; font-size: 0.5em !important; margin-top: 3px; margin-left: 2px; color: rgba(255, 255, 255, .7); font-size: 80%;">DIG</div>
					</div>
   ...
   <div class="tile double double-vertical bg-white" style="margin-top: -10px;">
        		...
        		<div class="tile double live" data-role="live-tile" data-effect="slideRight" data-easing="easeInSine"  style="margin-top: 3px !important;">
        	    	...
        	    	<div class="tile-content col-hspan125 padding5 bg-mauveLight">
						...
						<div class="ddp_group5 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"></div>
          					...
          					<div class="ddp_group2 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 27px; color: rgba(255, 255, 255, .7); display: none;"></div>
          					<div class="ddp_group1 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 27px; color: rgba(255, 255, 255, .7); display: none;"></div>
					</div>
	        		...
	        		<div style="postion: absolute; margin-top: 15px; margin-left: 5px;">
						...
						<div class="ddp_groupamt5 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 2px; color: rgba(255, 255, 255, .7);"></div>
          					...
          					<div class="ddp_groupamt2 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 28px; color: rgba(255, 255, 255, .7); display: none;"></div>
          					<div class="ddp_groupamt1 col-subspan spanxs label_subtitle animated fadeInDown" style="margin-left: 28px; color: rgba(255, 255, 255, .7); display: none;"></div>
					</div>
					
					<div class="animated fadeIn" style="position: absolute; margin-top: 85px; margin-left: 15px;">
						<div class="col-subspan spanxs label_subtitle" style="margin-left: 17px; color: rgba(255, 255, 255, 1);"><small>SB</small></div>
          					<div class="col-subspan spanxs label_subtitle" style="margin-left: 25px; color: rgba(255, 255, 255, 1);"><small>SME</small></div>
          					<div class="col-subspan spanxs label_subtitle" style="margin-left: 25px; color: rgba(255, 255, 255, 1);"><small>DIG</small></div>
          					<div class="col-subspan spanxs label_subtitle" style="margin-left: 29px; color: rgba(255, 255, 255, 1); display: none;"><small></small></div>
          					<div class="col-subspan spanxs label_subtitle" style="margin-left: 29px; color: rgba(255, 255, 255, 1); display: none;"><small></small></div>
						</div>
	...
	<a href="http://tc001pcis1u:8099/pcis/index.php/collection_control/getCollectionList" target="_blank">
