...
<div class="container">
	...
	<div id="dialog" title="Profile Validation" style="display: none;">
        <div class="grid">
            <div class="row">
	...
	<div id="form" class="row">
		...
		<?php echo form_open('create_data/profileFormIntial', $attributes); ?>
		
		<?php $form_succ = (isset($_GET['forms']) && isset($_GET['forms']) == 'success') ? 'Y':'N'; ?>
		
		<input id="fill_branchcode" type="hidden" value="<?php echo !empty($autofill['BranchCode']) ? $autofill['BranchCode'] : ''; ?>" />
		<input id="fill_source_field_id" name="fill_source_field_id" type="hidden" value="<?php echo !empty($autofill['SourceCode']) ? $autofill['SourceCode'] : ''; ?>" />
		<input id="fill_source_field" name="fill_source_field" type="hidden" value="<?php echo !empty($autofill['SourceField']) ? $autofill['SourceField'] : ''; ?>" />
	    ...
	    <fieldset>
	        ...
	        <article class="span12">
                <section class="span3">
	                <div class="input-control select size3" data-role="input-control" onclick="false">
	                    <div>Branch Code</div>
	                    ...
	                    <select name="branchcode" id="branchcode" style="background-color: #EBEBE4;">
	            ...
	            <section class="span3" data-hint="Branch|ฟิลด์นี้ไม่สามารถคีย์ข้อมูลหรือแก้ไขข้อมูลได้ " data-hint-position="top">
	                <div class="input-control text size3">
	                    <div>Branch</div>
	                    <input type="text" name="branch" id="branch" value="<?php echo !empty($session_data['branch'])?$session_data['branch']:""; ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : 'readonly="readonly"'; ?>>
	                </div>
	            ...
	            <section class="span3" data-hint="Region|ฟิลด์นี้ไม่สามารถคีย์ข้อมูลหรือแก้ไขข้อมูลได้ " data-hint-position="top">
	                <div id="parent_region" class="input-control text size3">
	                    <div>Region</div>
	                    <input type="text" name="region" id="region" value="<?php echo !empty($session_data['region'])? strtoupper($session_data['region']):""; ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : 'readonly="readonly"'; ?>>
	                </div>
	            </section>
	        ...
	        <article class="span12" style="margin-top: 30px;">
	            <section class="input-control text span12">
	                ...
	                <div class="input-control text span3" style="margin-left: 20px;">
					    <input name="rmcode" id="rmcode" type="text" value="<?php echo !empty($autofill['RMCode']) ? $autofill['RMCode'] : ''; ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
					...
					<div class="input-control text span3" style="margin-left: 20px;">
					 ...
					 <div class="input-control checkbox span1">
				        ...
				        <label>
				        	<input id="assign_case" name="assign_case" type="checkbox" value="Y" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	        ...
	        <article class="span12">
	            <section class="span3">
	                <div class="input-control text size3">
	                    <div>RM Name</div>
	                    <input type="text" name="empname" id="empname" value="<?php echo set_value('empname'); ?>" data-role="input-control" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                </div>
	            </section>
	            ...
	            <section class="span3">
	                <div class="input-control text size">
	                    <div>RM Mobile</div>
	                    <input type="text" name="rmmobile" id="rmmobile" value="<?php echo set_value('rmmobile'); ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                </div>
	            </section>
	            ...
	            <section class="span3 ui-widget">
	                <div class="input-control text size3">
	                    <div>BM Name</div>
	                    <input type="text" name="bm" id="bm" value="<?php echo !empty($session_data['bmname'])?$session_data['bmname']:""; ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                </div>
	    ...
	    <div class="span12" >
	        ...
	        <div class="input-control radio" style="margin-left: 20px;">
	            <div class="input-control radio">
	                <label>
	                    <input type="radio" name="register" value="N" checked="checked" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                    <span class="check"></span> ลูกค้าใหม่
	                </label>
	            </div>
	            <div class="input-control radio" style="margin-left: 29px;">
	                <label>
	                    <input type="radio" name="register" value="A" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div id="objSource" class="input-control select">
	            ...
	            <select id="sourceofcustomer" name="sourceofcustomer" class="span4" style="background-color: #EBEBE4;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                ...
	                <optgroup label="Referrel List">
		                ...
		                <option value="Tcrb: Facebook">Refer by TCRB FB</option>
	                 	...
	                 	<option value="Rabbit">Refer by Rabbit</option>
	                 	<option value="Fintech">Refer by Fintech</option>
	                 	<option value="Livechat">Refer by Livechat</option>
	    ...
	    <div id="sourcetextoption" class="span12">
	        <div class="input-control textarea">
	            ...
	            <textarea name="sourceoption" id="sourceoption" class="span4" cols="35" rows="3" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>><?php echo set_value('sourceoption'); ?></textarea>
	        </div>
	    </div>
	    ...
	    <div class="span12">
	        <div class="input-control select">
	            ...
	            <div class="input-control radio" style="margin-left: 20px;">
	                <label>
	                    <input type="radio" name="interest" value="0" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                    <span class="check"></span> สนใจ
	                </label>
	            </div>
	            <div class="input-control radio" style="margin-left: 5px;">
	                <label>
	                    <input type="radio" name="interest" value="1" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                    <span class="check"></span> ไม่สนใจ
	                </label>
	            </div>
	            <div class="input-control radio hide" style="margin-left: 5px;">
	                <label>
	                    <input type="radio" name="interest" value="2" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div class="input-control radio" data-hint="Customer Potential|ส่วนประเมินลูกค้าว่าอยู่ในเกณฑ์ใด ซึ่งการประเมินนี้ เป็นการประเมินศักยภาพในการทำสินเชื่อของลูกค้าในอนาคต." data-hint-position="right">
	            ...
	            <div class="input-control radio" style="margin-left: 20px;">
	                <label>
	                    <input type="radio" name="potential" value="0" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                    <span class="check"></span> H
	                </label>
	            </div>
	            <div class="input-control radio" style="margin-left: 27px;">
	                <label>
	                    <input type="radio" name="potential" value="1" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                    <span class="check"></span> M
	                </label>
	            </div>
	            <div class="input-control radio" style="margin-left: 40px;">
	                <label>
	                    <input type="radio" name="potential" value="2" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div class="input-control radio">
	            ...
	            <div class="input-control radio" style="margin-left: 20px;" data-hint="Nano Finance" data-hint-position="right">
	                <label>
	                    <input type="radio" name="loan_group" value="NN" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	            ...
	            <div class="input-control radio" style="margin-left: 17px;" data-hint="Micro Finance" data-hint-position="right">
	                <label>
	                    <input type="radio" name="loan_group" value="MF" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
				...
				<div class="input-control radio" style="margin-left: 33px;" data-hint="Small Business Loan" data-hint-position="right">
	                <label>
	                    <input type="radio" name="loan_group" value="SB" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	            ...
	            <div class="input-control radio" style="margin-left: 33px;" data-hint="Micro SME" data-hint-position="right">
	                <label>
	                    <input type="radio" name="loan_group" value="MF SME" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div class="input-control text" style="margin: 10px 0;">
	                ...
	                <div class="span4">
	                    <div class="input-control radio" style="margin-top: -20px;">
	                        <label class="span4 text">
	                            <input name="ownertype" type="radio" value="0" <?php echo (!empty($autofill['IsOwner']) && $autofill['IsOwner'] == 'Y') ? 'checked="checked"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	                            <span class="check"></span> ชื่อเจ้าของกิจการ
	                        </label>
	                        <label class="span4 text" style="margin-left: 1px;">
	                            <input name="ownertype" type="radio" value="1" <?php echo (!empty($autofill['IsOwner']) && $autofill['IsOwner'] == 'N') ? 'checked="checked"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	            ...
	            <div class="input-control select span1" style="margin-left: 20px; min-width: 65px;">
		            <select name="prefixname" id="prefixname" class="input-control select" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'style="background-color: #EBEBE4; height: 34px;"' : 'style="height: 34px;"'; ?>>
	                        <option value=""></option>
                ...
                <div class="input-control text span3">
					<input type="text" name="owner" id="owner" value="<?php echo !empty($autofill['Customer']) ? $autofill['Customer'] : ''; ?>" placeholder="ชื่อ-นามสกุล" style="margin-left: 3px; min-width: 230px;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12" style="margin-top: 3px;">
	        <div class="input-control text">
	            ...
	            <div class="input-control select span1" style="margin-left: 20px; min-width: 65px;">
	            <select name="prefixcorp" id="prefixcorp" class="input-control select" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'style="background-color: #EBEBE4; height: 34px;"' : 'style="height: 34px;"'; ?>>
                        <option value=""></option>
                ...
                <div class="input-control text span3">
					<input type="text" name="company" id="company" value="<?php echo !empty($autofill['Company']) ? $autofill['Company'] : ''; ?>" style="margin-left: 3px; min-width: 230px;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
					<button class="btn-clear"></button>
			   </div>
	        </div>
	    </div>
	    ...
	    <div class="span12">
	        <div class="input-control select">
	            ...
	            <select id="businesstype" name="businesstype" class="span4" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'style="background-color: #EBEBE4;"' : ''; ?>>
	    ...
	    <div id="business-free" class="span12">
	        <div class="input-control textarea">
	            ...
	            <textarea id="business"  name="business" cols="35" rows="3" class="span4" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>><?php echo set_value('business'); ?></textarea>
	    ...
	    <div id="parent_tel" class="span12">
	        <div class="input-control span8 text tooltip-right" data-tooltip="คำแนะนำ: ควรเป็นเบอร์ที่ใช้ในธุรกิจ เบอร์ร้าน หรือ เบอร์ สนง. เป็นต้น">
	            ...
	            <input type="text" name="telephone" id="telephone" class="span4" value="<?php echo !empty($autofill['Mobile']) ? str_pad($autofill['Mobile'], 10, '0', STR_PAD_LEFT) : ''; ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	        </div>
	    ...
	    <div class="span12">
	        <div class="input-control text span8 text tooltip-right" data-tooltip="คำแนะนำ: ควรเป็นเบอร์ที่ใช้ส่วนตัวขอลูกค้า เช่น เบอร์มือถือ เป็นต้น">
	            ...
	            <input type="text" name="mobile" id="mobile" class="span4" value="<?php echo set_value('mobile'); ?>" class="span4" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	        </div>
	    ...
	    <div class="span12 ui-widget">
	        <div class="input-control text">
	            ...
	            <input type="text" name="downtown" id="downtown" class="span4" value="<?php echo set_value('downtown'); ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div id="textarea_add" class="input-control textarea">
	            ...
	            <textarea id="address"  name="address" cols="35" rows="3" class="span4" style="font-size: 0.8em; font-weight: normal;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>><?php echo set_value('address'); ?></textarea>
	        </div>
	    </div>
	    ...
	    <div class="span12">
	        <div id="parent_province" class="input-control select">
	            ...
	            <?php echo ($form_succ == 'Y') ? '<div class="block_area"></div>' : ''; ?>
	    ...
	    <div class="span12">
	        <div class="input-control text">
	            ...
	            <input type="text" name="postcode" id="postcode" class="span4" value="<?php echo set_value('postcode'); ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	   ...
	   <div class="span12">
	        <div class="input-control select">
	            ...
	            <select id="channelmode" name="channelmode" class="span4" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'style="background-color: #EBEBE4;"' : ''; ?>>></select>
	    ...
	    <div class="span12">
	        <div class="input-control text">
	            ...
	            <input name="loanrequest" id="loanrequest" class="span4" value="<?php echo set_value('loanrequest'); ?>" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	        </div>
	    </div>
	    ...
	    <div class="span12">
	        ...
	        <label>
	        	<input type="checkbox" id="criteria" name="criteria" value="1" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	        	<span class="check"></span>
	        </label>
	        </div>
	        <div id="criteria_parent" class="input-control select span4" style="margin-left: -30px; max-width: 270px;">
	            <select id="criteria_reason" name="criteria_reason" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?> <?php echo ($form_succ == 'Y') ? 'style="background-color: #EBEBE4;"' : ''; ?>>></select>
	        </div>
	    ...
	    <div id="refertl_element" class="span12">
	        <div class="input-control text">
	            ...
	            <input id="referralcode" name="referralcode" type="text" class="span4" value="<?php echo set_value('referralcode'); ?>" maxlength="8" readonly="readonly" style="background-color: #EBEBE4;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>>
	    ...
	    <div class="span12">
	        <div class="input-control textarea">
	            ...
	            <textarea name="remark" id="remark" class="span4" cols="35" rows="3" style="font-size: 0.8em; font-weight: normal;" <?php echo ($form_succ == 'Y') ? 'disabled="disabled"' : ''; ?>><?php echo set_value('remark'); ?></textarea>
	        </div>
	    </div>
	    ...
	    <div class="span12">
	        ...
	        <div class="span6" style="padding-left: 60px;">	        	
	            <button id="submit" name="submit" type="submit" style="min-width: 80px; height: 34px; <?php echo ($form_succ == 'Y') ? 'display: none;' : ''; ?>" class="bg-lightBlue fg-white">
...
$('#navigation').fadeOut();
$('#contentation').css('margin-top', '0px');
