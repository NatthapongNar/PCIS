...
<div class="toolbar transparent" style="margin-left: 58px; padding: 5px; border: 1px solid #D1D1D1; max-width: 300px;">
   ...
   <a href="<?php echo site_url('metro/routers?_=').date('s').'&cache=false&secure='.md5(true).'&rel='.$_GET['rel'].'&req=P2&live=1'; ?>"><button><i class="fa fa-eye on-left"></i>Preview</button></a>
   <a href="#"><button><i class="fa fa-close on-left"></i>Edit</button></a>
</div>
	...
	<fieldset>
	    ...
	    <div class="span12">
	        ...
	        <label>
	        	...
	        	<input type="checkbox" name="HQNCBChecker" id="HQNCBChecker" <?php if($checker) echo "checked"; if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?> style="margin-top: 5px;">
	        	<span class="check"></span>
	        </label>
	        </div>
	        <div id="objHQNCBDatee" class="input-control text span4" style="margin-left: -30px; max-width: 270px;">
	            <input type="text" id="HQNCBDate" name="HQNCBDate" value="<?php echo !empty($results['data'][0]['HQGetNCBDate']) && ($results['data'][0]['HQGetNCBDate'] != '1900-01-01') ? StandartDateRollback($results['data'][0]['HQGetNCBDate']):""; ?>" <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
	            <span class="btn-date"></span>
	        </div>
	    </div>     
	    ...
	    <div class="span12">
	        ...
	        <div id="objSentToOperDate" class="input-control text span4" style="margin-left: -30px; max-width: 270px;">
	            <input type="text" id="HQSentToOperDate" name="HQSentToOperDate" value="<?php echo !empty($results['data'][0]['HQSentNCBToOperDate']) && ($results['data'][0]['HQSentNCBToOperDate'] != '1900-01-01') ? StandartDateRollback($results['data'][0]['HQSentNCBToOperDate']):""; ?>" <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
	            <span class="btn-date"></span>
	        </div>
	    ...
	    <div class="span12">
	        ...
	        <div id="parent_rmprocess" class="input-control select">
	            ...
	            <select name="rmprocess" id="rmprocess" class="span2 size2" style="min-width: 180px; height: 34px;">
	                ...
	                <option value="ยกเลิก โดย RM" <?php if($rmprocess == "ยกเลิก โดย RM") echo "selected"; ?>>ยกเลิก โดย RM</option>
	                <option value="ยกเลิก โดย ลูกค้า" <?php if($rmprocess == "ยกเลิก โดย ลูกค้า") echo "selected"; ?>>ยกเลิก โดย ลูกค้า</option>
	                </optgroup>
	            </select>
	    ...
	    <div class="span12">
	        <div id="parent_ems" class="input-control text">
	            ...
	            <input id="ems" name="ems" class="span2" maxlength="13" style="min-width: 160px; height: 34px;" value="<?php echo !empty($results['data'][0]['EMSNo']) ? $results['data'][0]['EMSNo']:""; ?>" data-hint="EMS No|โปรดระบุหมายเลข EMS หรือหากไม่มีกรุณาใส่เลขที่สาขาและระบุวันที่จัดส่งเอกสาร ตัวอย่าง: EN66942463TH หรือ  201 เป็นต้น" data-hint-position="top">
	    ...
	    <div class="span12">
	        ...
	        <div id="HQReceiveCADate" class="input-control text span4" style="margin-left: -30px; max-width: 270px;">
	            <input type="text" id="objHQReceiveCADate" name="HQReceiveCADate" value="<?php echo !empty($results['data'][0]['HQReceiveCADocDate']) && ($results['data'][0]['HQReceiveCADocDate'] != '1900-01-01') ? StandartDateRollback($results['data'][0]['HQReceiveCADocDate']):""; ?>" <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
	            <span class="btn-date"></span>
	        </div>
	    </div>       
   		...
   		<div class="span12">
	   		...
	   		<div class="input-control radio span1" style="min-width: 70px;">
                <label>
                    <input type="radio" id="lackdoc_notsend" name="lackdoc_notsend" value="0" checked="checked" <?php if($lack_completed == '0') echo 'checked'; ?> <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
                    <span class="check"></span>ไม่ครบ
                </label>
            </div>
            <div class="input-control radio span1">
                <label>
                    <input type="radio" id="lackdoc_send" name="lackdoc_notsend" value="1" <?php if($lack_completed == '1') echo 'checked'; ?> <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
            ...
            <div id="objLackdoc_sendDate" class="input-control text span2" style="margin-left: 10px; max-width: 270px;">
                <input type="text" id="lackdoc_sendDate" name="lackdoc_sendDate" value="<?php echo !empty($results['data'][0]['CompletionDocDate']) && ($results['data'][0]['CompletionDocDate'] != '1900-01-01') ? StandartDateRollback($results['data'][0]['CompletionDocDate']):""; ?>" <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
                <span class="btn-date"></span>
            </div>
   		</div>
   		...
   		<?php 
	   		...
	   		if(empty($lacklist['data'][0])) {
				...
				$i=1;
				$locked = ($session_data['branchcode'] <> '000') ? ' disabled="disabled"':false;
        ...
        <div class="span12">
            ...
            <div class="input-control radio span1" style="min-width: 70px;">
                <label>
                    <input type="radio" id="notsendto" name="sendto" value="0" <?php if(empty($SentDocToCA) || $SentDocToCA == '0') echo 'checked'; ?> <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
                    <span class="check"></span> ไม่ส่ง
                </label>
            </div>
            <div class="input-control radio span1">
                <label>
                    <input type="radio" id="sendto" name="sendto" value="1" <?php if($SentDocToCA == '1') echo 'checked'; ?> <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
                    <span class="check"></span> ส่ง
                </label>
            </div>
            <div id="clndrCADate" class="input-control text span2" style="margin-left: 10px; max-width: 270px;">
                <input type="text" id="CADate" name="CADate" value="<?php echo !empty($results['data'][0]['SentToCADate']) && ($results['data'][0]['SentToCADate'] != '1900-01-01') ? StandartDateRollback($results['data'][0]['SentToCADate']):""; ?>" <?php if($session_data['branchcode'] <> '000') { echo ' disabled="disabled"'; } ?>>
                <span class="btn-date"></span>
            </div>
        </div>
