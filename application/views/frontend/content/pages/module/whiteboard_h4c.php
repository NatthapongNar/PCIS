...
<div ng-controller="ctrlWhiteboardH4C" class="grid" ng-class="{ 'nonprint' : !print_screen }">
	...
	<div id="sidenav_container" class="sidenav close">
			...
			<div class="field padding_none">
				<div class="input-control checkbox">
				    <label class="margin_none">
				        <input id="cashy_field1" ng-model="filter.cashy_yesflag" type="checkbox" ng-click="filter.cashy_noflag = false" disabled="disabled">
				        <span class="check"></span> Yes
				    </label>
				</div>
				<div class="input-control checkbox marginLeft20">
				    <label class="margin_none">
				        <input id="cashy_field2" ng-model="filter.cashy_noflag" type="checkbox" ng-click="filter.cashy_yesflag = false" disabled="disabled">
		...
		<div class="content close" style="background-color: #4A4C4E !important;">
			...
			<div class="field padding_none fg-black">
				<div class="input-control text field_limitText margin_none fg-black">
					<input id="request_loan_1" ng-model="filter.requestloan_start" num-formatter="0" type="text" style="max-width: 107px !important;" disabled="disabled">
					<input id="request_loan_2" ng-model="filter.requestloan_end" num-formatter="0" type="text" style="max-width: 107px !important; float: right;" disabled="disabled">
				</div>
			</div>
		</div>
		<div class="content close">
			...
			<div class="field padding_none">
				<div class="input-control text field_limitText margin_none fg-black">
					<input id="plana2ca_range" name="plana2ca_range" ng-model="filter.plana2cadate" input-daterange-enable type="text" ng-change="changeFieldAllAuto(filter.plana2cadate, 'plana2ca')" disabled="disabled">
				</div>
			</div>
		</div>
		<div class="content close">
		...
		<div class="content close">
			...
			<div class="field padding_none">
				<div class="input-control text field_limitText margin_none fg-black">
					<input id="plandrawdown_range" name="plandrawdown_range" ng-model="filter.plandrawdown" input-daterange-enable type="text" ng-change="changeFieldAllAuto(filter.plandrawdown, 'plan_dd_date')" disabled="disabled">
				</div>
			</div>
		</div>
				...
				<div class="row margin_none place-right">
					...
					<div class="place-left place-right" style="min-width: 290px; text-align: right; border-left: 1px dotted #D1D1D1; max-height: 31px; margin-bottom: 10px;">
						<div class="input-control checkbox text-left">
		    				<label>
		    					<input id="performance_cm" name="performance_cm" ng-model="filter.performnaces" type="checkbox" ng-click="changePerformFieldFilter()" disabled="disabled"> <!-- ng-disabled="filter.drawdown_mth || filter.cn_flag" -->
						...
						<div class="input-control checkbox text-left">
		    				<label>
		    					<input id="drawdown_cm" name="drawdown_cm" ng-model="filter.drawdown_mth" type="checkbox" ng-click="changeDDFieldFilter()" disabled="disabled"> <!-- ng-disabled="filter.performnaces  || filter.cn_flag" -->
		    			...
		    			<div class="input-control checkbox text-left marginLeft10">
		    				<label>
		    					<input id="filter_cncancel" name="filter_cncancel" ng-model="filter.cn_flag" type="checkbox" disabled="disabled"> <!-- ng-disabled="filter.drawdown_mth || filter.performnaces" -->
			...
			<table id="grid_whiteboard" class="table bordered hovered">
				...
				<tfoot>	
					<tr class="fg-darkBlue text_bold">
						<td colspan="5" class="text-left">{{ grandTotal.current_page }}</td>	
						<td></td>					
			     	...
			     	<tr class="brands fg-white text_bold">
						<td colspan="5" class="text-left">{{ grandTotal.grandtotal_page }}</td>
						<td></td>
						<td class="text-right">{{ grandTotal.requestloan_footer | number: 0 }}</td>
						<td></td>
						<td></td>
						<td></td>	
						<td></td>
						...
						<td></td>
						<td></td>	
						<td class="text-right">{{ grandTotal.drawdownloan_footer | number: 0 }}</td>
						<td></td>
						<td></td>
			     	</tr>     	
				</tfoot>
